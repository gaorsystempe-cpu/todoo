...
export const MOCK_PRODUCTS: OdooProduct[] = [
  { id: 101, display_name: "[FARM001] Paracetamol 500mg (Caja x 100)", default_code: "FARM001", list_price: 15.00 },
  { id: 102, display_name: "[FARM002] Amoxicilina 500mg (Caja x 100)", default_code: "FARM002", list_price: 32.00 },
  { id: 103, display_name: "[FARM003] Ibuprofeno 400mg (Caja x 100)", default_code: "FARM003", list_price: 18.00 },
  { id: 104, display_name: "[FARM004] Alcohol Antiséptico 70° 1L", default_code: "FARM004", list_price: 12.00 },
  { id: 105, display_name: "[FARM005] Multivitamínico Supradyn x 30", default_code: "FARM005", list_price: 45.00 },
  { id: 106, display_name: "[FARM006] Mascarillas Quirúrgicas Celeste x 50", default_code: "FARM006", list_price: 8.50 },
  { id: 107, display_name: "[FARM007] Omeprazol 20mg (Caja x 30)", default_code: "FARM007", list_price: 10.00 },
  { id: 108, display_name: "[FARM008] Loratadina 10mg (Caja x 100)", default_code: "FARM008", list_price: 22.00 },
  { id: 109, display_name: "[FARM009] Vitamina C Redoxon Efervescente", default_code: "FARM009", list_price: 18.50 }
];
...
export const INITIAL_MOCK_RULES: CommissionRule[] = [
  { productId: 101, type: "percentage", value: 3 }, // 3% commission on Paracetamol
  { productId: 102, type: "percentage", value: 4 }, // 4% commission on Amoxicilina
  { productId: 103, type: "flat", value: 5 }, // $5 flat per Ibuprofeno box
  { productId: 105, type: "percentage", value: 5 }, // 5% on Multivitamins
  { productId: 108, type: "flat", value: 10 } // $10 flat per Loratadina box
];

export const MOCK_EXPIRY_ALERTS: ExpiryAlert[] = [
  {
    id: 1,
    productName: "Paracetamol 500mg (Caja x 100)",
    defaultCode: "FARM001",
  ...
  {
    id: 2,
    productName: "Amoxicilina 500mg (Caja x 100)",
    defaultCode: "FARM002",
  ...
  {
    id: 3,
    productName: "Ibuprofeno 400mg (Caja x 100)",
    defaultCode: "FARM003",
  ...
  {
    id: 4,
    productName: "Alcohol Antiséptico 70° 1L",
    defaultCode: "FARM004",
  ...
  {
    id: 5,
    productName: "Omeprazol 20mg (Caja x 30)",
    defaultCode: "FARM007",
  ...
  {
    id: 6,
    productName: "Loratadina 10mg (Caja x 100)",
    defaultCode: "FARM008",
  ...
  {
    id: 7,
    productName: "Vitamina C Redoxon Efervescente",
    defaultCode: "FARM009",
...
export const MOCK_POS_TRANSACTIONS: PosTransactionDetail[] = [
  ...
  },
  {
    ...
    productName: "Mascarillas Quirúrgicas Celeste x 50",
    qty: 1,
    priceUnit: 25.00,
    subtotal: 25.00,
    paymentMethod: "Yape / Plin"
